      ...
      <div className="relative w-full text-center z-10 px-4 sm:px-6 lg:px-8 uppercase">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-white text-black font-bold py-4 px-10 rounded-full text-lg shadow-2xl hover:bg-gray-100 transition-all duration-300 w-full sm:w-auto"
          >
            Join Now
          </motion.button>
          <motion.button
            ...
            className="border-2 border-white text-white font-bold py-4 px-10 rounded-full text-lg shadow-2xl hover:bg-white/10 transition-all duration-300 w-full sm:w-auto"
          >
            Download The App
          </motion.button>
        </motion.div>
